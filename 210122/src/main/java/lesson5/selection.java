...
public class selection {
    public static void main(String[] args) {
        ...
        Worker worker6 = new Worker("Григорьев Фома Акимович", "уборщик", "grigorev@mail.ru", "8-960-123-456-70", 35000, 69);
        ...
        for (Worker worker : workers) {
            if (worker.age >= 40) {
                ...
                System.out.printf("Сотрудник младше 40: %s%n", worker.fullName);
            }*/
        }
    }
}
